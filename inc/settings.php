...
// Display
define('TINYIB_PAGETITLE', 'lucichan');
define('TINYIB_LOGO', @file_get_contents("inc/header.html"));

// Thread management
define('TINYIB_THREADSPERPAGE', 7);
define('TINYIB_REPLIESTOSHOW',  4);
define('TINYIB_MAXTHREADS',     0);    // 0 disables deleting old threads
define('TINYIB_DELETE_TIMEOUT', 99999999);  // Seconds for deleting own posts
define('TINYIB_MAXPOSTSIZE',    8000); // Characters
define('TINYIB_RATELIMIT',      0);   // Delay between posts from same IP

// Passwords
define('TINYIB_ADMINPASS',  "se31c89r7989e89654tadmin982pass239word31369authkey000"); 
